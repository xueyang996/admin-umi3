...
const MatchStatus = (props: MatchStatusP) => {
  ...
  let annotationImage;
  if (data > 80) {
    colorGeo = ['item', ['l (270) 0:rgba(135,220,163,1) 1:rgba(47,195,124,1)', '#eeeff4']];
    ...
    colorGeo = ['item', ['l (270) 0:rgba(148,213,255,1) 1:rgba(19,162,255,1)', '#eeeff4']];
    ...
    colorGeo = ['item', ['l (270) 0:rgba(253,153,143,1) 1:rgba(249,96,86,1)', '#eeeff4']];
